...
public class ElementUtil {
	...
	@Step(" enter value : {1} into webelement : {0}")
	...
	@Step("get web element using By Locator: {0} ... ")
	 ...
	 * @return
	 */
	@Step("waiting for the web element using locator : {0} within timeout: {1}")
	...
	/**
	 * An expectation for checking an element is visible and enabled such that you can click it. Vijay
	 * @param locator
	 * @param timeOut
	 */
